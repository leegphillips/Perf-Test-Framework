...
public class PingApi {
    ...
    private com.squareup.okhttp.Call pingGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/crc/ping".replaceAll("\\{format\\}","json");
    ...
    public Object pingGet() throws ApiException {
        ApiResponse<Object> resp = pingGetWithHttpInfo();
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call pingGetAsync(final ApiCallback<Object> callback) throws ApiException {
